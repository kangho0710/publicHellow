	...
	let naverLogin = new naver.LoginWithNaverId(
		{
			...
			callbackUrl: "http://hellowu.co.kr/naver/oauth",
...
function loginWithGoogle(){
	if(confirm('SSL 인증서가 발급된 도메인이 아니기 때문에 테스트 사용자로 등록된 구글 계정만 로그인이 가능합니다.')){
...
function loginWithKakao() {
    Kakao.Auth.authorize({
      redirectUri: 'http://hellowu.co.kr/kakao/oauth',
    });
  }
